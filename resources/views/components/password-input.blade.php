...
{{-- Input sandi dengan tombol lihat/sembunyikan (rev user UAT 04) --}}
<div class="relative" x-data="{ show: false }">
    ...
    <button type="button" @click="show = !show"
            class="absolute inset-y-0 end-0 px-3 text-gray-400 hover:text-gray-600"
