<x-app-layout title="Dashboard Pegawai">
    ...
    {{-- Kartu kuota lebar penuh — info peminjaman aktif cukup disajikan
         SEKALI oleh panel besar di bawah (UAT 06-C3: dulu tampil 2 kartu,
         yang kecil tanpa tombol aksi) --}}
    <div class="rounded-xl border {{ $quota['remaining'] > 0 ? 'border-indigo-200 bg-indigo-50/50' : 'border-red-200 bg-red-50' }} p-5 mb-6">
