...
| A9 | **input baru** pengurus mengecek untuk event tertentu mobil apa saja yang dipakai | belum ada skema menampilkan mobil yang akan dipakai untuk event ketika di tanya oleh pegawai di bidang | revisi → uji ulang | diimplementasikan 2026-09-13: tombol **"Lihat armada (N unit)"** di tiap kartu event (menu Event Armada) menampilkan nama + plat seluruh unitnya |
| A10 | **input baru** event armada dibatalkan oleh pengurus | peminjaman mobil A oleh pegawai A yang ditabrak dan kemudian diganti kan oleh mobil B, karena event batal, harus nya peminjaman pegawai A kembali menggunakan mobil A tidak menggunakan pengganti mobil B | revisi → uji ulang | diimplementasikan 2026-09-13: batal event memulihkan booking (belum & sudah diganti) ke unit asal BILA unit asal bebas; bila sudah dipakai orang lain, tetap aman di pengganti |
...
| B6 | **Batalkan Event** (buat event baru uji) | Status **Dibatalkan**; armada lepas (bisa dipinjam lagi); booking **sudah diganti pun kembali ke mobil X bila bebas**; yang **belum** diganti kembali Dipinjam di mobil semula | revisi → uji ulang | cek poin A10 — sudah diimplementasikan, uji ulang |
