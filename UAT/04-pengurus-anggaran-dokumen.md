...
| B4c | **Verifikasi B4b (implementasi selesai)**: buka form melalui tombol **Edit Nota** | Judul form **"Edit Nota Bengkel"**; tombol bawah **oranye "Selesai Edit"** (bukan "Simpan Nota & Generate Dokumen" — label itu hanya saat input pertama, hijau) | ⬜ | |
...
| B6d | **Verifikasi B6b (implementasi selesai)**: regenerate bend26 4 pos → buka PDF | Teks **"Mengetahui dan menyetujui"** menempel langsung di atas "Pengguna Anggaran," — spasi atas/bawah dihilangkan di semua 4 pos | ⬜ | |
