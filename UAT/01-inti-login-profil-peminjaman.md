...
| D11 | **Jawaban D10 (implementasi + test teruji)**: booking Mobil A **kemarin..besok** (3 hari) → hari ini tekan Selesai | Status riwayat: **Dikembalikan** + waktu aktual (rentang asli kemarin..besar tetap tertera). ★ Mobil **LANGSUNG tersedia** untuk hari TERAKHIR (besok) — pegawai lain dapat langsung booking hari itu (teruji otomatis) | ⬜ | |
...
| F7 | **Pagination + filter bulan (revisi)**: buka Peminjaman Saya | **Default hanya bulan berjalan** (dropdown "Menampilkan riwayat: {bulan}" — pilih bulan lain untuk melihat data lama); peminjaman AKTIF selalu tampil; halaman 1 **tanpa tombol Sebelumnya**, halaman terakhir **tanpa tombol Berikutnya** | ⬜ | |
