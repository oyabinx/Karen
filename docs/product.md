...
| 27b | **Menu Realisasi Bulanan** bagi pengurus: tampilan default **daftar mobil** yang maintenance pada bulan terpilih (total + chip per pos) → klik mobil → rincian per pos beserta **rincian baris nota** expandable; tersedia pemilih bulan dan **ekspor CSV**. Form input nota **mobile-first** tanpa menampilkan angka koefisien. *(skema baru UAT 04)* |
